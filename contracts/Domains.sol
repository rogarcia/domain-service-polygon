...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld) payable ERC721("Hype Name Service", "HNS") {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        _name,
                        '", "description": "A domain on the Hype name service", "image": "data:image/svg+xml;base64,',
